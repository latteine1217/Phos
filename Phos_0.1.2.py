...
with st.sidebar:
    ...
    film_type = st.selectbox(
        ...
        NC200: 靈感來自富士C200彩色負片和掃描儀
        SP3000，旨在模仿經典的"富士色調"，通過
        還原"記憶色"，喚起對胶片的情感。

        AS100: 靈感來自富士ACROS系列黑白胶片，
        為正全色黑白胶片，對藍色最敏感，紅色次
        之，綠色最弱，成片灰階細膩，顆粒柔和，
        畫面銳利，對光影有很好的還原力。

        FS200: 高對比度黑白正片⌈光⌋，在開發初期
        作為原理驗證模型所使用，對藍色較敏感，對
        紅色較不敏感，對比鮮明，顆粒適中。
        '''
    )
